export const registerSystemSettings = function () {
  game.settings.register("octomori-sheet", "populateFromCompendia", {
  ...
  game.settings.register("octomori-sheet", "populateFromWorld", {
  ...
  game.settings.register("octomori-sheet", "showPronounsInCharacterDirectory", {
